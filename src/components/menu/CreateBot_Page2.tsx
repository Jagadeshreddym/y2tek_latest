...
const CreateBot_Page2 = () => {
    ...
    const handleNextPage = () => {
        navigation.navigate('createBot_Page3');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.subContainer_selected}>
                ...
                />
                <Text style={styles.title_selected}>Risk Managemenr Parameters</Text>
            </View>

            <ScrollView style={styles.scrollContainer}>
                <View style={styles.container_1} >
                    <View style={{ width: '100%', height: 60 }}>
                        <DropdownComponent data1={data} dropdowntype={'Margin'} />
                    </View>

                    <View style={styles.priceViewContainer_1}>
                        <View style={styles.priceView_11}>
                            <DropdownComponent data1={data} dropdowntype={'Target Profit'} />
                        </View>
                        <View style={styles.priceView_11}>
                            <DropdownComponent data1={data} dropdowntype={'GOAL'} />
                        </View>
                    </View>

                    <View style={styles.priceViewContainer_1}>
                        <View style={styles.priceView_11}>
                            <DropdownComponent data1={data} dropdowntype={'Stoploss'} />
                        </View>
                        <View style={styles.priceView_11}>
                            <DropdownComponent data1={data} dropdowntype={'GOAL'} />
                        </View>
                    ...
                    <View style={{ width: '100%', height: 50 }}>
                        <DropdownComponent data1={data} dropdowntype={'Max Dropdown Limit'} />
                    </View>

                    <View style={styles.container_11}>
                        <TouchableOpacity style={styles.target} onPress={handleNextPage}>
                            <Text style={styles.text}>Trailing Target</Text>
                            <Image
                                source={require("../../assets/images/total_trade.png")}
                            />
                        </TouchableOpacity>
                    ...
                    <View style={styles.container_11}>
                        <TouchableOpacity style={styles.target} onPress={handleNextPage}>
                            <Text style={styles.text}>Trailing Stoploss</Text>
                            <Image
                                source={require("../../assets/images/total_trade.png")}
                            />
                        </TouchableOpacity>
                    ...
                    <View style={styles.container_11}>
                        <TouchableOpacity style={styles.target} onPress={handleNextPage}>
                            <Text style={styles.text}>Reinvest Profit</Text>
                            <Image
                                source={require("../../assets/images/total_trade.png")}
                            />
                        </TouchableOpacity>
                    ...
                    <View style={styles.container_11}>
                        <TouchableOpacity style={styles.target} onPress={handleNextPage}>
                            <Text style={styles.text}>Allow Shorting</Text>
                            <Image
                                source={require("../../assets/images/total_trade.png")}
                            />
                        </TouchableOpacity>
...
export default CreateBot_Page2;